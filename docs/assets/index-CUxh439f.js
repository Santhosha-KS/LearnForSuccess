...
## ✍️ Author: Santhosha & AI Odds 😊 
 ...
 `}]},{id:1,emoji:`🧠`,title:`How AI Works`,color:`#6366f1`,sections:[{title:`What is AI?`,content:`Artificial Intelligence is a system that mimics human cognitive functions — reasoning, learning, problem-solving, and decision-making.
    {AILearningImage}   
**3 Layers of AI:**
...
- **Output** = Predictions, text, images, decisions`},{title:`AI vs ML vs Deep Learning vs GenAI`,content:`**Hierarchy (largest to smallest scope):**
...
- GenAI = "building a ChatBot SaaS on top of those frameworks"`}]},{id:2,emoji:`⚙️`,title:`Machine Learning Deep Dive`,color:`#0891b2`,sections:[{title:`How ML Works`,content:`ML models *learn patterns* from historical data to make predictions on new data.
...
Think of it as: **auto-tuning a configuration file until errors hit near zero.**`},{title:`Types of ML`,content:`**1. Supervised Learning**
...
- GPT abbrevaiate itself as - Generative Pre-Trained Transformers(Algoritham)`},{title:`Main Algorithms — A Developer's Cheat Sheet`,content:`| Algorithm | Type | Use Case | Complexity |
|-----------|------|----------|------------|
...
- CNNs for image tasks`}]},{id:3,emoji:`🔤`,title:`Tokens & How LLMs Work`,color:`#059669`,sections:[{title:`What is a Token?`,content:`A **token** is the basic unit of text an LLM processes. NOT a word, not a character — something in between.
{TokensImage}
...
- Longer context = more memory usage + more compute = higher cost`},{title:`How Tokenization Works Internally`,content:`LLMs use **Byte Pair Encoding (BPE)** or **SentencePiece** tokenization:
...
- Multi-head attention = parallel attention patterns`}]},{id:4,emoji:`💰`,title:`Pricing, Costs & Subscriptions`,color:`#d97706`,sections:[{title:`How AI API Charges Work`,content:`**Token-based pricing** — you pay per 1,000 or 1,000,000 tokens (varies by provider).
...
= (20,000 × $0.000003) + (5,000 × $0.000015) = $0.06 + $0.075 = ~$0.135`},{title:`Subscription vs API — When to Use What`,content:`**Consumer Subscriptions (Claude Pro, ChatGPT Plus ~$20/mo):**
...
- For teams/startups: Enterprise for data privacy`}]},{id:5,emoji:`🌐`,title:`How AI Fetches Data`,color:`#7c3aed`,sections:[{title:`Training Data vs Real-time Data`,content:`**Two completely different data pipelines:**
      {AITrainingImage}
      {GPT3Datasets}
...
- In production, **RAG is almost always the right choice** for knowledge bases, support bots, and internal tools. Fine-tuning is reserved for changing the model's *behaviour or style*, not its *knowledge*.`},{title:`Vector Embeddings — The Secret Sauce`,content:`**Simple Analogy First — The Map of Meaning**
...
**One-line mental model:** A Vector DB is like a SQL database, but instead of WHERE name = 'foo', you query WHERE meaning ≈ 'foo'.`}]},{id:6,emoji:`🏛️`,title:`Evolution of Claude, GPT & Gemini`,color:`#be185d`,sections:[{title:`GPT / OpenAI Timeline`,content:`| Year | Model | Key Milestone |
|------|-------|---------------|
...
**Key innovations:** RLHF (Reinforcement Learning from Human Feedback), multimodality, reasoning/thinking models`},{title:`Claude / Anthropic Timeline`,content:`| Year | Model | Key Milestone |
|------|-------|---------------|
...
**Anthropic's key differentiator:** Constitutional AI + safety research. Models are trained to be *helpful, harmless, and honest* using AI feedback rather than only human labelers.`},{title:`Gemini / Google Timeline`,content:`| Year | Model | Key Milestone |
|------|-------|---------------|
...
**Google's advantage:** Search index, YouTube data, Maps, proprietary TPU hardware, and owning the original Transformer architecture.`}]},{id:7,emoji:`🤖`,title:`How Claude Answers You`,color:`#0f766e`,sections:[{title:`The Full Answer Pipeline`,content:`When you send me a message, here's what happens technically:
...
**Total time:** 200ms–2s depending on output length and model size.`},{title:`🧠 Memory & Stateless Conversations — The Truth Every Dev Must Know`,content:` {ClaudeCodePillarsImage}
...
> Build your stateful layer (DB, vector store, session store) *around* it — not inside it.`},{title:`📋 System Prompt — The Hidden Director Behind Every AI App`,content:`## 🎭 What is a System Prompt?
...
- 📌 **Injects business context** — product info, pricing, policies, user data
 ...
 💡 **Dev tip:** The system prompt is your most powerful tool. A well-crafted system prompt can turn a general-purpose LLM into a laser-focused domain expert for your product — no fine-tuning required.`},{title:`Constitutional AI — Why Claude Behaves Differently`,content:`Anthropic's unique training method:
...
`}]},{id:8,emoji:`✍️`,title:`Prompt Engineering — Do's & Don'ts`,color:`#7c3aed`,sections:[{title:`🤔 Why Good Prompts Matter`,content:`## 💡 What is Prompt Engineering?
...
\`\`\``},{title:`✅ Do's — What Makes a Great Prompt`,content:`## ✅ The 6 Golden Rules of Good Prompts
...
\`\`\``},{title:`❌ Don'ts — Common Prompt Mistakes`,content:`## ❌ 7 Prompt Mistakes That Kill Response Quality
...
\`\`\``},{title:`🏆 Prompt Templates — Copy & Use`,content:`## 🏆 Ready-To-Use Prompt Templates for Senior Devs
...
| 🎯 Grounding | Reduce hallucination | "Base your answer only on the text below..." |`}]},{id:9,emoji:`🚀`,title:`Practical AI for Senior Devs`,color:`#b45309`,sections:[{title:`AI Stack for Building Products`,content:`**The Modern AI Engineering Stack:**
...
\`\`\``},{title:`Prompt Engineering — The Senior Dev Toolkit`,content:`**You already know software engineering — apply those principles:**
...
\`\`\``},{title:`Your 30-Day Learning Roadmap`,content:`**Week 1: Foundations**
...
- [Simon Willison's Blog — practical LLM engineering](https://simonwillison.net)`}]}],y=`modulepreload`,b=function(e){return`/LearnForSuccess/`+e},x={},ee=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=b(t,n),t in x)return;x[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:y,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})};function S(){let[e,t]=(0,d.useState)(0),[n,r]=(0,d.useState)(0),[i,a]=(0,d.useState)(!1),[o,s]=(0,d.useState)(``),[c,l]=(0,d.useState)(!1),[u,f]=(0,d.useState)(window.innerWidth<768);(0,d.useEffect)(()=>{let e=()=>f(window.innerWidth<768);return window.addEventListener(`resize`,e),()=>window.removeEventListener(`resize`,e)},[]);let p=v[e],g=p.sections[n],y=v.reduce((e,t)=>e+t.sections.length,0),b=v.slice(0,e).reduce((e,t)=>e+t.sections.length,0)+n+1,x=Math.round(b/y*100),S=[...g.content.matchAll(/\{(\w+)\}/g)].map(e=>e[1]),C=(e,t=p.color)=>{let n=e.replace(/\{\w+\}/g,``).split(`
`),r=[],i=0;for(;i<n.length;)if(n[i].startsWith(`|`)){let e=[];for(;i<n.length&&n[i].startsWith(`|`);)e.push(n[i]),i++;r.push({type:`table`,lines:e})}else if(n[i].startsWith("```")){i++;let e=[];for(;i<n.length&&!n[i].startsWith("```");)e.push(n[i]),i++;i++;let t=e[0]||``,a=t.startsWith(`title:`);r.push({type:`code`,title:a?t.replace(`title:`,``).trim():null,body:(a?e.slice(1):e).join(`
`)})}else r.push({type:`line`,value:n[i]}),i++;let a=e=>e.every(e=>/^[-: ]+$/.test(e)),o=e=>e.split(`|`).slice(1,-1).map(e=>e.trim());return r.map((e,n)=>{if(e.type===`table`){let r=e.lines.map(o),i=r[0],s=r.filter((e,t)=>t!==0&&!a(r[t]));return(0,h.jsx)(`div`,{style:{overflowX:`auto`,margin:`12px 0`},children:(0,h.jsxs)(`table`,{style:{width:`100%`,borderCollapse:`collapse`,fontSize:`0.85rem`},children:[(0,h.jsx)(`thead`,{children:(0,h.jsx)(`tr`,{children:i.map((e,n)=>(0,h.jsx)(`th`,{style:{padding:`8px 12px`,textAlign:`left`,fontWeight:600,color:t,borderBottom:`2px solid ${t}`,background:`var(--bg-secondary)`,whiteSpace:`nowrap`},children:e},n))})}),(0,h.jsx)(`tbody`,{children:s.map((e,t)=>(0,h.jsx)(`tr`,{style:{borderBottom:`1px solid var(--border-color)`,background:t%2==0?`transparent`:`var(--bg-secondary)`},children:e.map((e,t)=>(0,h.jsx)(`td`,{style:{padding:`7px 12px`,color:`var(--text-secondary)`,verticalAlign:`top`},children:e},t))},t))})]})},n)}if(e.type===`code`)return(0,h.jsxs)(`div`,{style:{margin:`12px 0`,borderRadius:`8px`,overflow:`hidden`,border:`1px solid var(--border-color)`},children:[e.title&&(0,h.jsxs)(`div`,{style:{background:`${t}22`,borderBottom:`1px solid ${t}44`,padding:`7px 16px`,display:`flex`,alignItems:`center`,gap:`8px`},children:[(0,h.jsx)(`div`,{style:{width:`3px`,height:`14px`,background:t,borderRadius:`2px`,flexShrink:0}}),(0,h.jsx)(`span`,{style:{fontSize:`0.75rem`,fontWeight:700,color:t,letterSpacing:`0.3px`},children:e.title})]}),(0,h.jsx)(`pre`,{style:{background:`var(--bg-secondary)`,padding:`16px`,overflowX:`auto`,fontSize:`0.78rem`,lineHeight:`1.6`,margin:0,borderLeft:`3px solid ${t}`},children:(0,h.jsx)(`code`,{style:{color:`var(--text-primary)`},children:e.body})})]},n);let r=e.value,i=e=>e.split(/(\*\*[^*]+\*\*|\[[^\]]+\]\([^)]+\))/g).map((e,n)=>{if(e.startsWith(`**`)&&e.endsWith(`**`))return(0,h.jsx)(`strong`,{style:{color:t},children:e.slice(2,-2)},n);let r=e.match(/^\[([^\]]+)\]\(([^)]+)\)$/);if(r){let e=/youtu\.be|youtube\.com/.test(r[2]);return(0,h.jsxs)(`a`,{href:r[2],target:`_blank`,rel:`noopener noreferrer`,style:{color:t,textDecoration:`underline`,display:`inline-flex`,alignItems:`center`,gap:`5px`},children:[e&&(0,h.jsx)(`svg`,{width:`18`,height:`13`,style:{flexShrink:0,verticalAlign:`middle`},children:(0,h.jsx)(`use`,{href:`/icons.svg#youtube-icon`})}),r[1]]},n)}return e});if(r.startsWith(`- `)||r.startsWith(`* `))return(0,h.jsx)(`li`,{style:{marginBottom:`4px`,marginLeft:`16px`},children:i(r.replace(/^[-*] /,``))},n);if(r.startsWith(`  - `)||r.startsWith(`  * `))return(0,h.jsx)(`li`,{style:{marginBottom:`3px`,marginLeft:`32px`,fontSize:`0.9rem`,color:`var(--text-secondary)`},children:i(r.replace(/^  [-*] /,``))},n);if(r.match(/^\d+\. /))return(0,h.jsx)(`li`,{style:{marginBottom:`4px`,marginLeft:`20px`,listStyleType:`decimal`},children:i(r.replace(/^\d+\. /,``))},n);if(r.startsWith(`#`)){let e=r.match(/^#+/)[0].length,i=r.replace(/^#+\s/,``);return(0,h.jsx)(`div`,{style:{fontSize:e===1?`1.2rem`:`1rem`,fontWeight:700,marginTop:`12px`,marginBottom:`4px`,color:t},children:i},n)}return r.startsWith(`[ ] `)?(0,h.jsxs)(`div`,{style:{display:`flex`,gap:`8px`,alignItems:`flex-start`,margin:`4px 0`},children:[(0,h.jsx)(`span`,{style:{fontSize:`1rem`,color:t},children:`☐`}),(0,h.jsx)(`span`,{children:i(r.slice(4))})]},n):r.trim()===``?(0,h.jsx)(`div`,{style:{height:`8px`}},n):(0,h.jsx)(`p`,{style:{margin:`3px 0`,lineHeight:`1.6`},children:i(r)},n)})},te=(0,d.useRef)(null),ne=(0,d.useRef)(null),re=(0,d.useRef)(null),[w,ie]=(0,d.useState)(!1),[ae,oe]=(0,d.useState)({}),se=async()=>{let e=[...new Set(v.flatMap(e=>e.sections.flatMap(e=>[...e.content.matchAll(/\{(\w+)\}/g)].map(e=>e[1]))))],t={};return await Promise.all(e.map(async e=>{for(let n of[`png`,`jpg`,`jpeg`])try{let r=await fetch(`/LearnForSuccess/images/${e}.${n}`);if(!r.ok)continue;let i=await r.blob();t[e]=await new Promise(e=>{let t=new FileReader;t.onload=t=>e(t.target.result),t.readAsDataURL(i)});break}catch{continue}})),t},ce=async()=>{ie(!0),oe(await se()),await new Promise(e=>setTimeout(e,400));try{let{jsPDF:e}=await ee(async()=>{let{jsPDF:e}=await import(`./jspdf.es.min-DRIMC8Co.js`);return{jsPDF:e}},__vite__mapDeps([0,1,2])),t=re.current.querySelectorAll(`.pdf-section`),n=null;for(let r=0;r<t.length;r++){let i=await(0,m.default)(t[r],{scale:1.5,useCORS:!0,backgroundColor:`#ffffff`}),a=i.toDataURL(`image/jpeg`,.92),o=i.height*210/i.width;r===0?n=new e({orientation:`p`,unit:`mm`,format:[210,o]}):n.addPage([210,o]),n.addImage(a,`JPEG`,0,0,210,o)}n.save(`AI_Field_Guide_Complete.pdf`)}finally{ie(!1),oe({})}},le=async()=>{if(!ne.current)return;let e=await(0,m.default)(ne.current,{scale:2,backgroundColor:`#ffffff`,useCORS:!0}),t=document.createElement(`a`);t.download=`${o.trim().replace(/\s+/g,`_`)}_Certificate.png`,t.href=e.toDataURL(`image/png`),t.click()};(0,d.useEffect)(()=>{te.current&&(te.current.scrollTop=0),window.scrollTo({top:0,behavior:`instant`})},[e,n]);let ue=()=>{n<p.sections.length-1?r(e=>e+1):e<v.length-1&&(t(e=>e+1),r(0))},T=()=>{n>0?r(e=>e-1):e>0&&(t(e=>e-1),r(v[e-1].sections.length-1))},E=e===0&&n===0,de=e===v.length-1&&n===p.sections.length-1;return(0,h.jsxs)(`div`,{style:{fontFamily:`system-ui, sans-serif`,height:`100dvh`,overflow:`hidden`,background:`var(--bg-primary)`,color:`var(--text-primary)`,display:`flex`,flexDirection:`column`},children:[(0,h.jsxs)(`nav`,{style:{background:`var(--bg-secondary)`,borderBottom:`1px solid var(--border-color)`,padding:u?`10px 12px`:`12px 20px`,display:`flex`,alignItems:`center`,gap:`10px`,position:`sticky`,top:0,zIndex:100,flexShrink:0},children:[(0,h.jsx)(`button`,{onClick:()=>a(e=>!e),style:{background:`transparent`,border:`none`,color:`var(--text-primary)`,cursor:`pointer`,fontSize:`1.2rem`,padding:`4px 8px`,borderRadius:`6px`,flexShrink:0},children:`☰`}),(0,h.jsxs)(`div`,{style:{flex:1,minWidth:0,overflow:`hidden`},children:[!u&&(0,h.jsx)(`div`,{style:{fontSize:`0.7rem`,fontWeight:700,letterSpacing:`2px`,color:p.color,textTransform:`uppercase`,whiteSpace:`nowrap`,overflow:`hidden`,textOverflow:`ellipsis`},children:`Comprehensive AI Course for Senior Engineers`}),(0,h.jsxs)(`div`,{style:{fontSize:u?`0.8rem`:`0.85rem`,fontWeight:600,marginTop:u?0:`1px`,whiteSpace:`nowrap`,overflow:`hidden`,textOverflow:`ellipsis`},children:[p.emoji,` `,p.title]})]}),(0,h.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`6px`,fontSize:`0.78rem`,color:`var(--text-secondary)`,flexShrink:0},children:[(0,h.jsx)(`div`,{style:{width:u?`56px`:`80px`,height:`6px`,background:`var(--border-color)`,borderRadius:`3px`,overflow:`hidden`},children:(0,h.jsx)(`div`,{style:{width:`${x}%`,height:`100%`,background:p.color,borderRadius:`3px`,transition:`width 0.3s`}})}),(0,h.jsxs)(`span`,{children:[x,`%`]})]})]}),(0,h.jsxs)(`div`,{style:{display:`flex`,flex:1,overflow:u?`auto`:`hidden`,flexDirection:u?`column`:`row`,position:`relative`},children:[i&&(0,h.jsx)(`div`,{onClick:()=>a(!1),style:{position:`fixed`,inset:0,background:`rgba(0,0,0,0.5)`,zIndex:49}}),(0,h.jsxs)(`aside`,{style:{width:`260px`,flexShrink:0,borderRight:`1px solid var(--border-color)`,padding:`16px 12px`,display:`flex`,flexDirection:`column`,gap:`4px`,overflowY:`auto`,background:`var(--bg-secondary)`,position:u?`fixed`:`sticky`,top:u?0:53,left:0,height:u?`100dvh`:`calc(100dvh - 53px)`,transform:i||!u?`translateX(0)`:`translateX(-100%)`,transition:`transform 0.25s ease`,zIndex:50},children:[(0,h.jsx)(`div`,{style:{fontSize:`0.7rem`,fontWeight:700,letterSpacing:`1px`,color:`var(--text-secondary)`,marginBottom:`8px`,textTransform:`uppercase`,paddingLeft:`6px`},children:`Modules`}),v.map((i,o)=>(0,h.jsxs)(`div`,{children:[(0,h.jsxs)(`button`,{onClick:()=>{t(o),r(0),a(!1)},style:{display:`flex`,alignItems:`center`,gap:`8px`,padding:`8px 10px`,borderRadius:`8px`,border:`none`,background:o===e?`${i.color}20`:`transparent`,color:o===e?i.color:`var(--text-secondary)`,cursor:`pointer`,textAlign:`left`,fontWeight:o===e?700:400,fontSize:`0.83rem`,transition:`all 0.2s`,width:`100%`},children:[(0,h.jsx)(`span`,{style:{fontSize:`1rem`},children:i.emoji}),(0,h.jsx)(`span`,{style:{flex:1},children:i.title}),(0,h.jsx)(`span`,{style:{fontSize:`0.7rem`,opacity:.6},children:i.sections.length})]}),o===e&&(0,h.jsx)(`div`,{style:{marginLeft:`8px`,marginTop:`2px`,display:`flex`,flexDirection:`column`,gap:`2px`},children:i.sections.map((e,t)=>(0,h.jsxs)(`button`,{onClick:()=>{r(t),a(!1)},style:{display:`flex`,alignItems:`center`,gap:`6px`,padding:`5px 10px 5px 28px`,borderRadius:`6px`,border:`none`,background:t===n?`${i.color}15`:`transparent`,color:t===n?i.color:`var(--text-secondary)`,cursor:`pointer`,textAlign:`left`,fontSize:`0.78rem`,fontWeight:t===n?600:400,width:`100%`,transition:`all 0.15s`},children:[(0,h.jsx)(`span`,{style:{width:`5px`,height:`5px`,borderRadius:`50%`,background:t===n?i.color:`var(--border-color)`,flexShrink:0}}),e.title]},t))})]},o))]}),(0,h.jsxs)(`main`,{ref:te,style:{flex:u?`none`:1,padding:u?`20px 16px`:`28px 32px`,overflowY:u?`visible`:`auto`,maxWidth:u?`none`:S.length?`700px`:`760px`,minWidth:0},children:[(0,h.jsxs)(`div`,{style:{borderLeft:`3px solid ${p.color}`,paddingLeft:`16px`,marginBottom:`24px`},children:[(0,h.jsxs)(`div`,{style:{fontSize:`0.72rem`,fontWeight:600,color:p.color,letterSpacing:`1px`,textTransform:`uppercase`,marginBottom:`4px`},children:[`Module `,p.id,` · Section `,n+1,` of `,p.sections.length]}),(0,h.jsx)(`h1`,{style:{margin:0,fontSize:`1.4rem`,fontWeight:800,color:`var(--text-primary)`},children:g.title})]}),(0,h.jsx)(`div`,{style:{display:`flex`,gap:`8px`,marginBottom:`24px`,flexWrap:`wrap`},children:p.sections.map((e,t)=>(0,h.jsx)(`button`,{onClick:()=>r(t),style:{padding:`5px 14px`,borderRadius:`20px`,border:`1.5px solid ${t===n?p.color:`var(--border-color)`}`,background:t===n?p.color:`transparent`,color:t===n?`#fff`:`var(--text-secondary)`,cursor:`pointer`,fontSize:`0.78rem`,fontWeight:600,transition:`all 0.2s`},children:e.title.length>22?e.title.slice(0,22)+`…`:e.title},t))}),(0,h.jsx)(`div`,{style:{lineHeight:`1.7`,fontSize:`0.93rem`},children:C(g.content)}),(0,h.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,alignItems:`center`,marginTop:`40px`,paddingTop:`20px`,borderTop:`1px solid var(--border-color)`},children:[(0,h.jsx)(`button`,{onClick:T,disabled:E,style:{padding:`10px 20px`,borderRadius:`8px`,border:`1.5px solid var(--border-color)`,background:`transparent`,color:`var(--text-primary)`,cursor:E?`not-allowed`:`pointer`,fontSize:`0.85rem`,opacity:E?.3:1,fontWeight:500},children:`← Previous`}),(0,h.jsxs)(`span`,{style:{fontSize:`0.78rem`,color:`var(--text-secondary)`},children:[b,` / `,y,` sections`]}),(0,h.jsx)(`button`,{onClick:ue,disabled:de,style:{padding:`10px 20px`,borderRadius:`8px`,border:`none`,background:de?`var(--border-color)`:p.color,color:`#fff`,cursor:de?`not-allowed`:`pointer`,fontSize:`0.85rem`,fontWeight:600,opacity:de?.5:1},children:de?`Complete ✓`:`Next →`})]}),de&&(0,h.jsxs)(`div`,{style:{marginTop:`32px`,padding:`28px`,borderRadius:`16px`,background:`linear-gradient(135deg, #6366f122, #7c3aed22)`,border:`1.5px solid #6366f144`,textAlign:`center`},children:[(0,h.jsx)(`div`,{style:{fontSize:`2rem`,marginBottom:`8px`},children:`🎓`}),(0,h.jsx)(`div`,{style:{fontSize:`1.1rem`,fontWeight:800,color:`var(--text-primary)`,marginBottom:`6px`},children:`You've completed the course!`}),(0,h.jsx)(`div`,{style:{fontSize:`0.85rem`,color:`var(--text-secondary)`,marginBottom:`20px`},children:`Enter your name and claim your certificate of completion.`}),(0,h.jsx)(`input`,{type:`text`,placeholder:`Enter your full name...`,value:o,onChange:e=>s(e.target.value),style:{width:`100%`,maxWidth:`320px`,padding:`10px 16px`,borderRadius:`8px`,border:`1.5px solid #6366f155`,background:`var(--bg-secondary)`,color:`var(--text-primary)`,fontSize:`0.95rem`,marginBottom:`14px`,display:`block`,margin:`0 auto 14px`,outline:`none`,boxSizing:`border-box`}}),(0,h.jsxs)(`div`,{style:{display:`flex`,gap:`12px`,justifyContent:`center`,flexWrap:`wrap`},children:[(0,h.jsx)(`button`,{onClick:()=>o.trim()&&l(!0),style:{padding:`11px 32px`,borderRadius:`8px`,border:`none`,background:o.trim()?`#6366f1`:`var(--border-color)`,color:`#fff`,fontSize:`0.9rem`,fontWeight:700,cursor:o.trim()?`pointer`:`not-allowed`,transition:`background 0.2s`},children:`🏆 Get My Certificate`}),(0,h.jsx)(`button`,{onClick:ce,disabled:w,style:{padding:`11px 32px`,borderRadius:`8px`,border:`none`,background:w?`var(--border-color)`:`#059669`,color:`#fff`,fontSize:`0.9rem`,fontWeight:700,cursor:w?`not-allowed`:`pointer`,transition:`background 0.2s`},children:w?`⏳ Generating PDF...`:`📄 Download AI Course PDF`})]})]})]}),c&&(0,h.jsxs)(`div`,{style:{position:`fixed`,inset:0,zIndex:999,background:`rgba(0,0,0,0.85)`,display:`flex`,alignItems:u?`flex-start`:`center`,justifyContent:`center`,padding:u?`16px`:`24px`,paddingBottom:u?`80px`:`24px`,overflowY:`auto`},children:[(0,h.jsxs)(`div`,{ref:ne,style:{background:`#fff`,borderRadius:`16px`,padding:u?`32px 20px`:`52px 60px`,maxWidth:`680px`,width:`100%`,textAlign:`center`,boxShadow:`0 0 80px #6366f155`,border:u?`5px solid #6366f1`:`8px solid #6366f1`,position:`relative`,fontFamily:`Georgia, serif`},children:[[`top-left`,`top-right`,`bottom-left`,`bottom-right`].map(e=>(0,h.jsx)(`div`,{style:{position:`absolute`,top:e.includes(`top`)?`12px`:`auto`,bottom:e.includes(`bottom`)?`12px`:`auto`,left:e.includes(`left`)?`12px`:`auto`,right:e.includes(`right`)?`12px`:`auto`,fontSize:`1.4rem`,opacity:.4},children:`✦`},e)),(0,h.jsx)(`div`,{style:{fontSize:`2.8rem`,marginBottom:`4px`},children:`🎓`}),(0,h.jsx)(`div`,{style:{fontSize:`0.78rem`,fontWeight:700,letterSpacing:`4px`,color:`#6366f1`,textTransform:`uppercase`,marginBottom:`10px`,fontFamily:`system-ui`},children:`Certificate of Completion`}),(0,h.jsx)(`div`,{style:{fontSize:`0.85rem`,color:`#666`,marginBottom:`18px`,fontStyle:`italic`},children:`This is to certify that`}),(0,h.jsx)(`div`,{style:{fontSize:u?`1.6rem`:`2rem`,fontWeight:800,color:`#1a1a2e`,borderBottom:`2px solid #6366f144`,paddingBottom:`10px`,marginBottom:`18px`,fontFamily:`Georgia, serif`},children:o}),(0,h.jsx)(`div`,{style:{fontSize:`0.9rem`,color:`#444`,marginBottom:`6px`},children:`has successfully completed`}),(0,h.jsx)(`div`,{style:{fontSize:u?`1rem`:`1.25rem`,fontWeight:700,color:`#6366f1`,marginBottom:`6px`},children:`Comprehensive AI Field Guide for Software Engineers`}),(0,h.jsx)(`div`,{style:{fontSize:`0.8rem`,color:`#888`,marginBottom:`28px`},children:`Covering AI/ML, LLMs, RAG, Prompt Engineering & Practical AI Stack`}),(0,h.jsxs)(`div`,{style:{display:`flex`,justifyContent:u?`center`:`space-between`,alignItems:`center`,flexDirection:u?`column`:`row`,gap:u?`10px`:0,borderTop:`1px solid #eee`,paddingTop:`20px`},children:[(0,h.jsxs)(`div`,{style:{textAlign:`center`},children:[(0,h.jsx)(`div`,{style:{fontSize:`0.95rem`,fontWeight:700,color:`#1a1a2e`},children:`Santhosha 😊`}),(0,h.jsx)(`div`,{style:{fontSize:`0.75rem`,color:`#888`},children:`Course Author`})]}),(0,h.jsx)(`div`,{style:{textAlign:`center`},children:(0,h.jsx)(`div`,{style:{fontSize:`1.6rem`},children:`⭐`})}),(0,h.jsxs)(`div`,{style:{textAlign:`center`},children:[(0,h.jsx)(`div`,{style:{fontSize:`0.85rem`,fontWeight:600,color:`#1a1a2e`},children:new Date().toLocaleDateString(`en-GB`,{day:`numeric`,month:`long`,year:`numeric`})}),(0,h.jsx)(`div`,{style:{fontSize:`0.75rem`,color:`#888`},children:`Date of Completion`})]})]})]}),(0,h.jsxs)(`div`,{style:{position:`fixed`,bottom:`20px`,left:`50%`,transform:`translateX(-50%)`,display:`flex`,gap:`10px`,alignItems:`center`,whiteSpace:`nowrap`},children:[(0,h.jsxs)(`button`,{onClick:le,style:{background:`#6366f1`,border:`none`,color:`#fff`,borderRadius:`20px`,padding:`10px 22px`,fontSize:`0.85rem`,fontWeight:700,cursor:`pointer`,display:`flex`,alignItems:`center`,gap:`6px`,whiteSpace:`nowrap`},children:[(0,h.jsx)(`span`,{style:{fontSize:`1rem`,lineHeight:1},children:`⬇`}),(0,h.jsx)(`span`,{children:`Download Certificate`})]}),(0,h.jsx)(`button`,{onClick:()=>l(!1),style:{background:`rgba(255,255,255,0.15)`,border:`1px solid rgba(255,255,255,0.3)`,color:`#fff`,borderRadius:`20px`,padding:`10px 18px`,fontSize:`0.85rem`,cursor:`pointer`,whiteSpace:`nowrap`},children:`✕ Close`})]})]}),S.length>0&&(0,h.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`20px`,padding:u?`0 16px 24px`:`24px 16px`,borderLeft:u?`none`:`1px solid var(--border-color)`,borderTop:u?`1px solid var(--border-color)`:`none`,minWidth:u?`auto`:`280px`,maxWidth:u?`none`:`420px`,width:`100%`,overflowY:u?`visible`:`auto`,flexShrink:u?1:0},children:S.map((e,t)=>(0,h.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`8px`},children:[(0,h.jsx)(`div`,{style:{fontSize:`0.7rem`,fontWeight:700,letterSpacing:`0.5px`,color:p.color,textTransform:`uppercase`},children:e.replace(/([A-Z]{2,})([A-Z][a-z])/g,`$1 $2`).replace(/([a-z])([A-Z])/g,`$1 $2`).replace(/([a-zA-Z])([0-9])/g,`$1 $2`).replace(/([0-9])([a-zA-Z])/g,`$1 $2`).trim()}),(0,h.jsx)(_,{name:e,color:p.color})]},t))})]}),w&&(0,h.jsx)(`div`,{ref:re,style:{position:`fixed`,left:`-9999px`,top:0,width:`860px`,background:`#fff`,zIndex:-1},children:v.map((e,t)=>e.sections.map((n,r)=>{let i=[...n.content.matchAll(/\{(\w+)\}/g)].map(e=>e[1]);return(0,h.jsxs)(`div`,{className:`pdf-section`,style:{width:`860px`,padding:`56px 64px`,boxSizing:`border-box`,background:`#ffffff`,fontFamily:`system-ui, sans-serif`,borderBottom:`4px solid #f0f0f0`},children:[(0,h.jsxs)(`div`,{style:{fontSize:`10px`,fontWeight:700,letterSpacing:`2px`,color:e.color,textTransform:`uppercase`,marginBottom:`6px`},children:[e.emoji,` Module `,e.id,` — `,e.title]}),(0,h.jsx)(`div`,{style:{fontSize:`22px`,fontWeight:800,color:`#1a1a2e`,borderLeft:`4px solid ${e.color}`,paddingLeft:`14px`,marginBottom:`24px`,lineHeight:1.3},children:n.title}),(0,h.jsx)(`div`,{style:{fontSize:`13px`,lineHeight:`1.75`,color:`#222`},children:C(n.content,e.color)}),i.filter(e=>ae[e]).map((e,t)=>(0,h.jsx)(`div`,{style:{marginTop:`20px`},children:(0,h.jsx)(`img`,{src:ae[e],alt:e,style:{maxWidth:`100%`,borderRadius:`8px`,border:`1px solid #e5e7eb`}})},t)),(0,h.jsxs)(`div`,{style:{marginTop:`32px`,paddingTop:`12px`,borderTop:`1px solid #e5e7eb`,display:`flex`,justifyContent:`space-between`,fontSize:`10px`,color:`#999`},children:[(0,h.jsx)(`span`,{children:`Complete AI Field Guide for Software Engineers`}),(0,h.jsxs)(`span`,{children:[`Section `,r+1,` of `,e.sections.length]})]})]},`${t}-${r}`)}))})]})}function C(){return(0,h.jsx)(S,{})}(0,u.createRoot)(document.getElementById(`root`)).render((0,h.jsx)(d.StrictMode,{children:(0,h.jsx)(C,{})}));export{ee as t};